...
export default function PaymentForm() {
  ...
  if (isLoading) {
    return (
      <div className="text-gray-800 dark:text-white px-4 md:px-6 lg:px-8 py-6 md:py-8 text-[13px]">
        <div className="text-center py-8">
          <div className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-[#0077B6]"></div>
          <p className="mt-3 text-gray-600 dark:text-[#0077B6]">Loading packages...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="flex justify-center mb-4 md:mb-4">
          <div className="inline-flex bg-gray-50 dark:bg-gray-800/30 rounded-sm md:rounded-sm p-0.5 md:p-1 border border-gray-200 dark:border-gray-700">
            <button
              ...
              className={`px-3 md:px-5 py-1.5 md:py-2 text-[11px] md:text-[12px] font-medium rounded-sm md:rounded-sm transition-all duration-200 ${
                activeTab === 'monthly'
            ...
            <button
              ...
              className={`px-3 md:px-5 py-1.5 md:py-2 text-[11px] md:text-[12px] font-medium rounded-sm md:rounded-sm transition-all duration-200 mx-0.5 md:mx-1 ${
                activeTab === 'annual'
                  ? 'bg-white dark:bg-[#026ba3] text-gray-800 shadow-xs border border-gray-300 dark:border-gray-600'
            ...
            {currentPackages.map((pkg, index) => {
              ...
              return (
                <div 
                  ...
                  className={`relative rounded-sm md:rounded-sm border transition-all duration-300 ${
                    isSelected
                ...
                >
                  ...
                  {/* Card Content */}
                  <div className={`p-5 md:p-6 rounded-sm md:rounded-sm ${
                    isPopular 
                    ...
                    <div className="text-center">
                      <button
                        ...
                        className={`w-full max-w-xs py-3 rounded-sm text-[13px] font-semibold transition-all duration-200 flex items-center justify-center gap-2 mx-auto ${
                          isSelected
