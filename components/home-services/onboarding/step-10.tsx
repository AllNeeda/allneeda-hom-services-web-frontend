...
export default function PaymentForm() {
  ...
  // Show the full-page global loader only while fetching packages.
  // For the checkout action we show an inline/contained spinner on the button
  // to avoid two full-screen loaders appearing.
  if (isLoading) {
    return (
                ...
                >
                  ...
                  {hasDiscount && discountPercentage && (
                    <div className="absolute -top-2 -right-2 z-10">
                      <div className="bg-red-500 to-pink-500 text-white px-3 py-1 rounded-full text-[10px] font-bold shadow-md">
                  ...
                  <div className={`p-5 md:p-6 rounded-sm md:rounded-sm ${isPopular
                    ? 'bg-blue-50/40 to-white dark:from-blue-900/10 dark:to-gray-800'
                    ...
                    <div className="text-center">
                      <button
                        ...
                        className={`w-full max-w-xs py-3 rounded-sm text-[13px] font-semibold transition-all duration-200 flex items-center justify-center gap-2 mx-auto ${isSelected
                          ? 'bg-[#0077B6] to-[#00A8E8] text-white shadow-md'
                          : isPopular
                            ? 'bg-[#0077B6] to-[#00A8E8] text-white hover:from-[#006699] hover:to-[#0077B6] shadow-sm hover:shadow-md'
          ...
          <div className="mt-8 md:mt-10 max-w-5xl mx-auto">
            ...
            <div className="text-center">
              <button
                ...
                disabled={loading}
                className={`px-8 py-3 bg-[#0077B6] text-white rounded-sm hover:from-[#006699] hover:to-[#0077B6] transition-all duration-200 shadow-md hover:shadow-lg flex items-center justify-center gap-2 group mx-auto ${loading ? 'opacity-60 cursor-not-allowed' : ''}`}
              >
                {loading ? (
                  // small inline spinner to indicate checkout processing
